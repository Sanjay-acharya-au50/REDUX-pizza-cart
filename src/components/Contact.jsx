    ...
    <>
      <div className="bg-black text-white p-5">
        <p className="  m-1 md:m-5 p-1 md:p-5 ">
          If you have any questions, need assistance, or would like to explore
          ...
          valuable insights, or answer any questions you may have. <br />
          <br />A website built using React and Redux combines the power of
